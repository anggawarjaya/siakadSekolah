	...
	class Jadwal extends CI_Controller
	{
		...
		function index()
		{
			...
			if ($this->session->userdata('id_level_user') == 3) {
				$anak = $this->session->userdata('id_guru');
				$sql = "SELECT tj.id_jadwal, tju.nama_jurusan, ttk.nama_tingkatan, tm.nama_mapel, tj.jam, 
						...
						WHERE tj.kd_jurusan = tju.kd_jurusan AND tj.kd_ruangan = tr.kd_ruangan AND tj.kd_mapel = tm.kd_mapel AND tj.kd_tingkatan = ttk.kd_tingkatan AND tj.id_guru = '$anak'";
